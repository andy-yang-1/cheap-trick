...
//     float4 _2 = *(float4*)(A + ((((((int)blockIdx.x) * 131072) + (((int)threadIdx.y) * 8192)) + ((((int)threadIdx.x) >> 1) * 1024)) + ((((int)threadIdx.x) & 1) * 4)));
//     A_shared[_1.x] = _2.x;
//     A_shared[_1.y] = _2.y;
//     A_shared[_1.z] = _2.z;
//     A_shared[_1.w] = _2.w;
//   *(float4*)(B_shared + (((((((int)threadIdx.y) >> 1) * 128) + ((((int)threadIdx.x) & 1) * 64)) + ((((int)threadIdx.y) & 1) * 32)) + ((((int)threadIdx.x) >> 1) * 4))) = *(float4*)(B + (((((((int)threadIdx.y) >> 1) * 1024) + (((int)blockIdx.y) * 128)) + ((((int)threadIdx.y) & 1) * 64)) + (((int)threadIdx.x) * 4)));
//   // #pragma unroll
...
//     //   float4 _4 = *(float4*)(A + ((((((((int)blockIdx.x) * 131072) + (((int)threadIdx.y) * 8192)) + ((((int)threadIdx.x) >> 1) * 1024)) + (i2_0 * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 8));
//     //   A_shared[_3.x] = _4.x;
//     //   A_shared[_3.y] = _4.y;
//     //   A_shared[_3.z] = _4.z;
//     //   A_shared[_3.w] = _4.w;
//     // *(float4*)(B_shared + (((((((i2_0 + 1) & 1) * 1024) + ((((int)threadIdx.y) >> 1) * 128)) + ((((int)threadIdx.x) & 1) * 64)) + ((((int)threadIdx.y) & 1) * 32)) + ((((int)threadIdx.x) >> 1) * 4))) = *(float4*)(B + ((((((i2_0 * 8192) + ((((int)threadIdx.y) >> 1) * 1024)) + (((int)blockIdx.y) * 128)) + ((((int)threadIdx.y) & 1) * 64)) + (((int)threadIdx.x) * 4)) + 8192));
    
//     *(float4*)(A_load) = *(float4*)(A + ((((((((int)blockIdx.x) * 131072) + (((int)threadIdx.y) * 8192)) + ((((int)threadIdx.x) >> 1) * 1024)) + (i2_0 * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 8));
//     *(float4*)(B_load) = *(float4*)(B + ((((((i2_0 * 8192) + ((((int)threadIdx.y) >> 1) * 1024)) + (((int)blockIdx.y) * 128)) + ((((int)threadIdx.y) & 1) * 64)) + (((int)threadIdx.x) * 4)) + 8192));

//     __syncthreads();
//     #pragma unroll // **
//     for (int i2_1 = 0; i2_1 < 8; ++i2_1) {
//       // #pragma unroll
//       for (int ax0_0 = 0; ax0_0 < 2; ++ax0_0) {
//         *(float4*)(B_shared_local + (ax0_0 * 4)) = *(float4*)(B_shared + (((((i2_0 & 1) * 1024) + (i2_1 * 128)) + (ax0_0 * 64)) + (((int)threadIdx.y) * 4)));
//       }
//       #pragma unroll
//       for (int ax0_01 = 0; ax0_01 < 2; ++ax0_01) {
//         *(float4*)(A_shared_local + (ax0_01 * 4)) = *(float4*)(A_shared + (((((i2_0 & 1) * 1024) + (i2_1 * 128)) + (ax0_01 * 64)) + (((int)threadIdx.x) * 4)));
//       }
//       #pragma unroll
...
//     int4 _3 = make_int4(((((((((i2_0 + 1) & 1) * 1024) + ((((int)threadIdx.x) & 1) * 512)) + ((((int)threadIdx.x) >> 3) * 64)) + (((int)threadIdx.y) * 4)) + ((((int)threadIdx.x) & 7) >> 1)))+(128*0), ((((((((i2_0 + 1) & 1) * 1024) + ((((int)threadIdx.x) & 1) * 512)) + ((((int)threadIdx.x) >> 3) * 64)) + (((int)threadIdx.y) * 4)) + ((((int)threadIdx.x) & 7) >> 1)))+(128*1), ((((((((i2_0 + 1) & 1) * 1024) + ((((int)threadIdx.x) & 1) * 512)) + ((((int)threadIdx.x) >> 3) * 64)) + (((int)threadIdx.y) * 4)) + ((((int)threadIdx.x) & 7) >> 1)))+(128*2), ((((((((i2_0 + 1) & 1) * 1024) + ((((int)threadIdx.x) & 1) * 512)) + ((((int)threadIdx.x) >> 3) * 64)) + (((int)threadIdx.y) * 4)) + ((((int)threadIdx.x) & 7) >> 1)))+(128*3));
//     A_shared[_3.x] = A_load[0];
//     A_shared[_3.y] = A_load[1];
//     A_shared[_3.z] = A_load[2];
//     A_shared[_3.w] = A_load[3];
//     *(float4*)(B_shared + (((((((i2_0 + 1) & 1) * 1024) + ((((int)threadIdx.y) >> 1) * 128)) + ((((int)threadIdx.x) & 1) * 64)) + ((((int)threadIdx.y) & 1) * 32)) + ((((int)threadIdx.x) >> 1) * 4))) = *(float4*)(B_load) ;
...
//   __syncthreads();
//   #pragma unroll
//   for (int i2_11 = 0; i2_11 < 8; ++i2_11) {
//     for (int ax0_02 = 0; ax0_02 < 2; ++ax0_02) {
//       *(float4*)(B_shared_local1 + (ax0_02 * 4)) = *(float4*)(B_shared + ((((i2_11 * 128) + (ax0_02 * 64)) + (((int)threadIdx.y) * 4)) + 1024));
//     }
//     for (int ax0_03 = 0; ax0_03 < 2; ++ax0_03) {
//       *(float4*)(A_shared_local1 + (ax0_03 * 4)) = *(float4*)(A_shared + ((((i2_11 * 128) + (ax0_03 * 64)) + (((int)threadIdx.x) * 4)) + 1024));
//     }
//     #pragma unroll
//     for (int i0_21 = 0; i0_21 < 8; ++i0_21) {
//       #pragma unroll
//       for (int i1_21 = 0; i1_21 < 8; ++i1_21) {
//         Y_local[((i0_21 * 8) + i1_21)] = (Y_local[((i0_21 * 8) + i1_21)] + (A_shared_local1[i0_21] * B_shared_local1[i1_21]));
//       }
//     }
//   }
